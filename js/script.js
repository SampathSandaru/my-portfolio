...
function sendmail(param) {
    ...
    emailjs.send('service_bzj8duha', 'template_3quvf6f', temParam).then(function (res) {
...
function scrollFunction() {
    ...
    sections.forEach(section => {
        if (scrollPosition >= section.offsetTop - section.offsetHeight * 0.2 && scrollPosition < section.offsetTop + section.offsetHeight - section.offsetHeight * 0.2) {
